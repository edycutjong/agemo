<div align="center">
  <img src="docs/assets/readme-hero.png" alt="Agemo Hero" width="100%">
  
  <p><em>Autonomous AI growth agent via Torque MCP. Analyze → Optimize → Execute loop.</em></p>
  
  [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen.svg)](https://torque-mcp.vercel.app)
  [![Pitch Video](https://img.shields.io/badge/Pitch-Video-red.svg)](https://youtube.com/your-video)
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-torque-mcp)
</div>
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-torque-mcp.git
   cd frontier-torque-mcp
   ```
